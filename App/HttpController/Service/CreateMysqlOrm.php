...
class CreateMysqlOrm extends ServiceBase
{
    ...
    function createMysqlOrm(): bool
    {
        ...
        $config->setMaxObjectNum(90); //设置最大连接池存在连接对象数量
    ...
    function createRDS3JinChuKouOrm(): bool
    {
        $config = new Config();
        ...
        DbManager::getInstance()->addConnection(
            new Connection($config), CreateConf::getInstance()->getConf('env.mysqlDatabaseRDS_3_jin_chu_kou')
        );

        return true;
    }

    function createRDS3ShangPinTiaoMaOrm(): bool
    {
        $config = new Config();
        ...
        DbManager::getInstance()->addConnection(
            new Connection($config), CreateConf::getInstance()->getConf('env.mysqlDatabaseRDS_3_shang_pin_tiao_ma')
        );
    ...
    function createRDS3HdSaicOrm(): bool
    {
        $config = new Config();
        ...
        $config->setUser(CreateConf::getInstance()->getConf('env.mysqlUserRDS_3'));
        $config->setPassword(CreateConf::getInstance()->getConf('env.mysqlPasswordRDS_3'));
        $config->setDatabase(CreateConf::getInstance()->getConf('env.mysqlDatabaseRDS_3_hd_saic'));
        $config->setCharset('utf8mb4');
        ...
        DbManager::getInstance()->addConnection(
            new Connection($config), CreateConf::getInstance()->getConf('env.mysqlDatabaseRDS_3_hd_saic')
        );
        return true;
    }

    function createRDS3HdSaicExtensionOrm(): bool
    {
        $config = new Config();
        ...
        $config->setUser(CreateConf::getInstance()->getConf('env.mysqlUserRDS_3'));
        $config->setPassword(CreateConf::getInstance()->getConf('env.mysqlPasswordRDS_3'));
        $config->setDatabase(CreateConf::getInstance()->getConf('env.mysqlDatabaseRDS_3_hd_saic_extension'));
        $config->setCharset('utf8mb4');
        ...
        DbManager::getInstance()->addConnection(
            new Connection($config), CreateConf::getInstance()->getConf('env.mysqlDatabaseRDS_3_hd_saic_extension')
        );
        return true;
    }

    function createRDS3HdBusinessOrm(): bool
    {
        $config = new Config();
        ...
        $config->setUser(CreateConf::getInstance()->getConf('env.mysqlUserRDS_3'));
        $config->setPassword(CreateConf::getInstance()->getConf('env.mysqlPasswordRDS_3'));
        $config->setDatabase('business_base');
        $config->setCharset('utf8mb4');
        ...
        DbManager::getInstance()->addConnection(new Connection($config), 'business_base');
        return true;
    }

    function createRDS3ZhaoTouBiaoOrm(): bool
    {
        $config = new Config();
        ...
        $config->setUser(CreateConf::getInstance()->getConf('env.mysqlUserRDS_3'));
        $config->setPassword(CreateConf::getInstance()->getConf('env.mysqlPasswordRDS_3'));
        $config->setDatabase(CreateConf::getInstance()->getConf('env.mysqlDatabaseRDS_3_zhao_tou_biao'));
        $config->setCharset('utf8mb4');
        ...
        DbManager::getInstance()->addConnection(
            new Connection($config), CreateConf::getInstance()->getConf('env.mysqlDatabaseRDS_3_zhao_tou_biao')
        );
        return true;
    }


    function createRDS3LogoKuOrm(): bool
    {
        $config = new Config();
        ...
        DbManager::getInstance()->addConnection(
            new Connection($config), CreateConf::getInstance()->getConf('env.mysqlDatabaseRDS_3_logo_ku')
        );
