...
class FinanceRange
{
    ...
    public $range_tc = [
        ...
        [
            ...
            ['name' => '-67', 'range' => [-1000000000, -900000000]],
            ['name' => '-66', 'range' => [-900000000, -800000000]],
            ['name' => '-65', 'range' => [-800000000, -700000000]],
            ['name' => '-64', 'range' => [-700000000, -600000000]],
            ['name' => '-63', 'range' => [-600000000, -500000000]],
            ['name' => '-62', 'range' => [-500000000, -400000000]],
            ['name' => '-61', 'range' => [-400000000, -300000000]],
            ['name' => '-60', 'range' => [-300000000, -200000000]],
            ['name' => '-59', 'range' => [-200000000, -100000000]],
            ['name' => '-58', 'range' => [-100000000, -90000000]],
            ['name' => '-57', 'range' => [-90000000, -80000000]],
            ['name' => '-56', 'range' => [-80000000, -70000000]],
            ['name' => '-55', 'range' => [-70000000, -60000000]],
            ['name' => '-54', 'range' => [-60000000, -50000000]],
            ['name' => '-53', 'range' => [-50000000, -40000000]],
            ['name' => '-52', 'range' => [-40000000, -30000000]],
            ['name' => '-51', 'range' => [-30000000, -20000000]],
            ['name' => '-50', 'range' => [-20000000, -10000000]],
            ['name' => '-49', 'range' => [-10000000, -9000000]],
            ['name' => '-48', 'range' => [-9000000, -8000000]],
            ['name' => '-47', 'range' => [-8000000, -7000000]],
            ['name' => '-46', 'range' => [-7000000, -6000000]],
            ['name' => '-45', 'range' => [-6000000, -5000000]],
            ['name' => '-44', 'range' => [-5000000, -4000000]],
            ['name' => '-43', 'range' => [-4000000, -3000000]],
            ['name' => '-42', 'range' => [-3000000, -2000000]],
            ['name' => '-41', 'range' => [-2000000, -1000000]],
            ['name' => '-40', 'range' => [-1000000, -900000]],
            ['name' => '-39', 'range' => [-900000, -800000]],
            ['name' => '-38', 'range' => [-800000, -700000]],
            ['name' => '-37', 'range' => [-700000, -600000]],
            ['name' => '-36', 'range' => [-600000, -500000]],
            ['name' => '-35', 'range' => [-500000, -400000]],
            ['name' => '-34', 'range' => [-400000, -300000]],
            ['name' => '-33', 'range' => [-300000, -200000]],
            ['name' => '-32', 'range' => [-200000, -100000]],
            ['name' => '-31', 'range' => [-100000, -90000]],
            ['name' => '-30', 'range' => [-90000, -80000]],
            ['name' => '-29', 'range' => [-80000, -70000]],
            ['name' => '-28', 'range' => [-70000, -60000]],
            ['name' => '-27', 'range' => [-60000, -50000]],
            ['name' => '-26', 'range' => [-50000, -40000]],
            ['name' => '-25', 'range' => [-40000, -30000]],
            ['name' => '-24', 'range' => [-30000, -20000]],
            ['name' => '-23', 'range' => [-20000, -10000]],
            ['name' => '-22', 'range' => [-10000, -9000]],
            ['name' => '-21', 'range' => [-9000, -8000]],
            ['name' => '-20', 'range' => [-8000, -7000]],
            ['name' => '-19', 'range' => [-7000, -6000]],
            ['name' => '-18', 'range' => [-6000, -5000]],
            ['name' => '-17', 'range' => [-5000, -4000]],
            ['name' => '-16', 'range' => [-4000, -3000]],
            ['name' => '-15', 'range' => [-3000, -2000]],
            ['name' => '-14', 'range' => [-2000, -1000]],
            ['name' => '-13', 'range' => [-1000, -900]],
            ['name' => '-12', 'range' => [-900, -800]],
            ['name' => '-11', 'range' => [-800, -700]],
            ['name' => '-10', 'range' => [-700, -600]],
            ['name' => '-9', 'range' => [-600, -500]],
            ['name' => '-8', 'range' => [-500, -400]],
            ['name' => '-7', 'range' => [-400, -300]],
            ['name' => '-6', 'range' => [-300, -200]],
            ['name' => '-5', 'range' => [-200, -100]],
            ['name' => '-4', 'range' => [-100, -50]],
            ['name' => '-3', 'range' => [-50, -10]],
            ['name' => '-2', 'range' => [-10, 0]],
            ['name' => '1', 'range' => [0, 0]],
            ...
            ['name' => '3', 'range' => [10, 50]],
            ['name' => '4', 'range' => [50, 100]],
            ['name' => '5', 'range' => [100, 200]],
            ['name' => '6', 'range' => [200, 300]],
            ['name' => '7', 'range' => [300, 400]],
            ['name' => '8', 'range' => [400, 500]],
            ['name' => '9', 'range' => [500, 600]],
            ['name' => '10', 'range' => [600, 700]],
            ['name' => '11', 'range' => [700, 800]],
            ['name' => '12', 'range' => [800, 900]],
            ['name' => '13', 'range' => [900, 1000]],
            ['name' => '14', 'range' => [1000, 2000]],
            ['name' => '15', 'range' => [2000, 3000]],
            ['name' => '16', 'range' => [3000, 4000]],
            ['name' => '17', 'range' => [4000, 5000]],
            ['name' => '18', 'range' => [5000, 6000]],
            ['name' => '19', 'range' => [6000, 7000]],
            ['name' => '20', 'range' => [7000, 8000]],
            ['name' => '21', 'range' => [8000, 9000]],
            ['name' => '22', 'range' => [9000, 10000]],
            ['name' => '23', 'range' => [10000, 20000]],
            ['name' => '24', 'range' => [20000, 30000]],
            ['name' => '25', 'range' => [30000, 40000]],
            ['name' => '26', 'range' => [40000, 50000]],
            ['name' => '27', 'range' => [50000, 60000]],
            ['name' => '28', 'range' => [60000, 70000]],
            ['name' => '29', 'range' => [70000, 80000]],
            ['name' => '30', 'range' => [80000, 90000]],
            ['name' => '31', 'range' => [90000, 100000]],
            ['name' => '32', 'range' => [100000, 200000]],
            ['name' => '33', 'range' => [200000, 300000]],
            ['name' => '34', 'range' => [300000, 400000]],
            ['name' => '35', 'range' => [400000, 500000]],
            ['name' => '36', 'range' => [500000, 600000]],
            ['name' => '37', 'range' => [600000, 700000]],
            ['name' => '38', 'range' => [700000, 800000]],
            ['name' => '39', 'range' => [800000, 900000]],
            ['name' => '40', 'range' => [900000, 1000000]],
            ['name' => '41', 'range' => [1000000, 2000000]],
            ['name' => '42', 'range' => [2000000, 3000000]],
            ['name' => '43', 'range' => [3000000, 4000000]],
            ['name' => '44', 'range' => [4000000, 5000000]],
            ['name' => '45', 'range' => [5000000, 6000000]],
            ['name' => '46', 'range' => [6000000, 7000000]],
            ['name' => '47', 'range' => [7000000, 8000000]],
            ['name' => '48', 'range' => [8000000, 9000000]],
            ['name' => '49', 'range' => [9000000, 10000000]],
            ['name' => '50', 'range' => [10000000, 20000000]],
            ['name' => '51', 'range' => [20000000, 30000000]],
            ['name' => '52', 'range' => [30000000, 40000000]],
            ['name' => '53', 'range' => [40000000, 50000000]],
            ['name' => '54', 'range' => [50000000, 60000000]],
            ['name' => '55', 'range' => [60000000, 70000000]],
            ['name' => '56', 'range' => [70000000, 80000000]],
            ['name' => '57', 'range' => [80000000, 90000000]],
            ['name' => '58', 'range' => [90000000, 100000000]],
            ['name' => '59', 'range' => [100000000, 200000000]],
            ['name' => '60', 'range' => [200000000, 300000000]],
            ['name' => '61', 'range' => [300000000, 400000000]],
            ['name' => '62', 'range' => [400000000, 500000000]],
            ['name' => '63', 'range' => [500000000, 600000000]],
            ['name' => '64', 'range' => [600000000, 700000000]],
            ['name' => '65', 'range' => [700000000, 800000000]],
            ['name' => '66', 'range' => [800000000, 900000000]],
            ['name' => '67', 'range' => [900000000, 1000000000]],
