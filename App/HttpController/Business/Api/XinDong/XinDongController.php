...
class XinDongController extends XinDongBase
{
    ...
    function isElectronicsLogin(): bool
    {
        ...
        TaskService::getInstance()->create(function () use ($nsrsbh, $loginType, $nsrdq, $traceno, $callback, $qd, $dlsf, $dlsfmm, $zjh, $gsnsmm, $sfzjhm, $gsnsyhm, $bsryxz) {
            CommonService::getInstance()->log4PHP('taskstart:' . time(), 'info', 'wanghan123');
            ...
            return CommonService::getInstance()->log4PHP('taskstop:' . time(), 'info', 'wanghan123');
        });
...
// Comparison function
    ...
    static function traverseMenu($menus, &$result, $pid): bool
    {
    ...
    function testExport()
    {
        ...
        if (
            ...
            curl_setopt($ch, CURLOPT_URL, 'https://xindongle.pingcode.com/api/agile/projects/633d7dbdb03312b442493522/scrum/backlog/views/5c9dc318b12fa218af0785fc/content');
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
            curl_setopt($ch, CURLOPT_POST, 1);
            curl_setopt($ch, CURLOPT_POSTFIELDS, "{\"querystring\":\"pi=0&ps=100&view%5Bsearch%5D%5Bkeywords%5D=&view%5Bsearch%5D%5Bscopes%5D%5B0%5D=identifier&view%5Bsearch%5D%5Bscopes%5D%5B1%5D=title&view%5Bconditions%5D%5B0%5D%5Boperation%5D=9&view%5Bconditions%5D%5B0%5D%5Bproperty_key%5D=state_id&view%5Bconditions%5D%5B0%5D%5Bvalue%5D%5B0%5D=626601eb7b52812bdf943b29&view%5Bconditions%5D%5B0%5D%5Bvalue%5D%5B1%5D=626601eb7b52812bdf943b2a&view%5Bconditions%5D%5B0%5D%5Blogic%5D=1&view%5Bshow_type%5D=1&view%5Bgroup_by%5D=&view%5Bsort_by%5D=identifier&view%5Bsort_type%5D=1\"}");
            curl_setopt($ch, CURLOPT_ENCODING, 'gzip, deflate');
            curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0); // Skip SSL Verification
            $headers = array();
            $headers[] = 'Host: xindongle.pingcode.com';
            $headers[] = 'Sec-Ch-Ua: \"Not?A_Brand\";v=\"8\", \"Chromium\";v=\"108\", \"Google Chrome\";v=\"108\"';
            $headers[] = 'Sec-Ch-Ua-Mobile: ?0';
            $headers[] = 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36';
            $headers[] = 'Content-Type: application/json';
            $headers[] = 'Accept: application/json, text/plain, */*';
            $headers[] = 'Baggage: sentry-environment=production,sentry-public_key=30b771ff6ea7496db9d7825f2bb95c63,sentry-trace_id=d2c969c5697e46e99a2d68d4bcc9fd9a,sentry-sample_rate=1';
            $headers[] = 'Sentry-Trace: d2c969c5697e46e99a2d68d4bcc9fd9a-abf936e71429d22f-1';
            $headers[] = 'Sec-Ch-Ua-Platform: \"Windows\"';
            $headers[] = 'Origin: https://xindongle.pingcode.com';
            $headers[] = 'Sec-Fetch-Site: same-origin';
            $headers[] = 'Sec-Fetch-Mode: cors';
            $headers[] = 'Sec-Fetch-Dest: empty';
            $headers[] = 'Referer: https://xindongle.pingcode.com/pjm/projects/QTYWKTKAXMTZ/backlog/5c9dc318b12fa218af0785fc';
            $headers[] = 'Accept-Language: zh-CN,zh;q=0.9,en;q=0.8,zh-TW;q=0.7';
            $headers[] = 'Cookie: wt_aid=e1283d18-920a-4ba3-9528-3dba032d6fa9; 9daf8dfdc099c207_gdp_user_key=; 9daf8dfdc099c207_gdp_session_id=b9c6c4c4-b839-459c-b959-5e30252d38d3; gdp_user_id=gioenc-eed0b6d6%2Cb1ec%2C51b2%2Cc458%2Ccba043205b49; 9daf8dfdc099c207_gdp_session_id_b9c6c4c4-b839-459c-b959-5e30252d38d3=true; s-626601ebe0553fae3cf29553=82e673c34ef542c2b26e692e27d79ae4; 9daf8dfdc099c207_gdp_cs1=gioenc-6g9ag83ebd5d5e468a69c466ec018e2c; 9daf8dfdc099c207_gdp_gio_id=gioenc-6g9ag83ebd5d5e468a69c466ec018e2c; 9daf8dfdc099c207_gdp_sequence_ids={%22globalKey%22:24%2C%22VISIT%22:2%2C%22PAGE%22:14%2C%22CUSTOM%22:7%2C%22LOGIN_USER_ATTRIBUTES%22:4}';
...
//                break;
        ...
        if (
            ...
            curl_setopt($ch, CURLOPT_URL, 'https://xindongle.pingcode.com/api/agile/projects/633d7e490f8aaa653c606025/scrum/backlog/views/5c9dc318b12fa218af0785fc/content');
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
            curl_setopt($ch, CURLOPT_POST, 1);
            curl_setopt($ch, CURLOPT_POSTFIELDS, "{\"querystring\":\"pi=0&ps=50&view%5Bsearch%5D%5Bkeywords%5D=&view%5Bsearch%5D%5Bscopes%5D%5B0%5D=identifier&view%5Bsearch%5D%5Bscopes%5D%5B1%5D=title&view%5Bshow_type%5D=1&view%5Bgroup_by%5D=&view%5Bsort_by%5D=identifier&view%5Bsort_type%5D=1\"}");
            curl_setopt($ch, CURLOPT_ENCODING, 'gzip, deflate');
            ...
            $headers[] = 'Content-Type: application/json';
            $headers[] = 'Accept: application/json, text/plain, */*';
            $headers[] = 'Baggage: sentry-environment=production,sentry-public_key=30b771ff6ea7496db9d7825f2bb95c63,sentry-trace_id=365aec6096e34c57bb4747bff6ee4f4a,sentry-sample_rate=1';
            $headers[] = 'Sentry-Trace: 365aec6096e34c57bb4747bff6ee4f4a-8b73f05879b6bbf9-1';
            $headers[] = 'Sec-Ch-Ua-Platform: \"Windows\"';
            $headers[] = 'Origin: https://xindongle.pingcode.com';
            $headers[] = 'Sec-Fetch-Site: same-origin';
            $headers[] = 'Sec-Fetch-Mode: cors';
            $headers[] = 'Sec-Fetch-Dest: empty';
            $headers[] = 'Referer: https://xindongle.pingcode.com/pjm/projects/ZDYYJFHKNLJS/backlog/5c9dc318b12fa218af0785fc';
            $headers[] = 'Accept-Language: zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6';
            $headers[] = 'Cookie: wt_aid=e1283d18-920a-4ba3-9528-3dba032d6fa9; 9daf8dfdc099c207_gdp_user_key=; gdp_user_id=gioenc-eed0b6d6%2Cb1ec%2C51b2%2Cc458%2Ccba043205b49; s-626601ebe0553fae3cf29553=82e673c34ef542c2b26e692e27d79ae4; 9daf8dfdc099c207_gdp_cs1=gioenc-6g9ag83ebd5d5e468a69c466ec018e2c; 9daf8dfdc099c207_gdp_gio_id=gioenc-6g9ag83ebd5d5e468a69c466ec018e2c; 9daf8dfdc099c207_gdp_session_id=fc5486e2-98c1-404b-ac72-b73d131a769e; 9daf8dfdc099c207_gdp_session_id_fc5486e2-98c1-404b-ac72-b73d131a769e=true; 9daf8dfdc099c207_gdp_sequence_ids={%22globalKey%22:78%2C%22VISIT%22:7%2C%22PAGE%22:45%2C%22CUSTOM%22:17%2C%22LOGIN_USER_ATTRIBUTES%22:12}';
            curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
...
//            $res  =  CompanyRiskService::getDatas(
//              [
//                  '北京华锐怡贤艺苑商场',
//                  '北京市门头沟区三建公司苇子水建筑队',
//                  '北京市天龙世纪精密机电配件厂新技术开发部',
