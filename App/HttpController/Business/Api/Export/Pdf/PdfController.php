...
class PdfController extends ExportBase
{
    ...
    function createVeryEasy()
    {
        ...
        $charge = ChargeService::getInstance()->VeryEasyReportCustomized($this->request(), 211, $reportNum);
        ...
        if ($charge['code'] != 200) {
            ...
            $code = 200;
            $paging = null;
            $res = ReportService::getInstance()->createVeryEasyPdf($entName, $reportNum, $phone, $type, $dataKey);
            $msg = '极简报告定制版生成中';
        }
    ...
    function createDeep()
    {
        ...
        $charge = ChargeService::getInstance()->EasyReportCustomized($this->request(), 231, $reportNum);
        ...
        if ($charge['code'] != 200) {
            ...
            $code = 200;
            $paging = null;
            $res = ReportService::getInstance()->createDeepPdf($entName, $reportNum, $phone, $type, $dataKey);
            $msg = '深度报告定制版生成中';
        }
