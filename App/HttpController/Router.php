...
class Router extends AbstractRouter
{
    ...
    private function GuoPiaoRouterV1(RouteCollector $routeCollector)
    {
        ...
        $routeCollector->addGroup('/zw', function (RouteCollector $routeCollector) use ($prefix) {
            ...
            $routeCollector->addRoute(['GET', 'POST'], '/getInvoiceOcrV2', $prefix . 'getInvoiceOcrV2');//发票实时ocr查验
            $routeCollector->addRoute(['GET', 'POST'], '/checkInvoice', $prefix . 'checkInvoice');//发票实时ocr查验
    ...
    private function XinDongRouterV1(RouteCollector $routeCollector)
    {
        ...
        $routeCollector->addGroup('/xd', function (RouteCollector $routeCollector) use ($prefix) {
            ...
            $routeCollector->addRoute(['GET', 'POST'], '/advancedSearchOption', $prefix . 'advancedSearchOption');// 高级搜索 https://api.meirixindong.com//api/v1/xd/advancedSearch
            ...
            $routeCollector->addRoute(['GET', 'POST'], '/uploadBusinessOpportunity', $prefix . 'uploadBusinessOpportunity');// 营收规模 https://api.meirixindong.com/api/v1/xd/uploadBusinessOpportunity
            $routeCollector->addRoute(['GET', 'POST'], '/getEsBasicInfo', $prefix . 'getEsBasicInfo');// 营收规模 https://api.meirixindong.com/api/v1/xd/getIntroduction
            $routeCollector->addRoute(['GET', 'POST'], '/getShangPinInfo', $prefix . 'getShangPinInfo');// 营收规模 https://api.meirixindong.com/api/v1/xd/getShangPinInfo
            ...
            $routeCollector->addRoute(['GET', 'POST'], '/matchFuzzyNameByLanguageMode', $prefix . 'matchFuzzyNameByLanguageMode');// 营收规模 https://api.meirixindong.com/api/v1/xd/matchFuzzyNameByLanguageMode
            ...
            $routeCollector->addRoute(['GET', 'POST'], '/queryUsedVehicleInfo', $prefix . 'queryUsedVehicleInfo');// 营收规模 https://api.meirixindong.com/api/v1/xd/queryUsedVehicleInfo
            ...
            //客动 
            $routeCollector->addRoute(['GET', 'POST'], '/addCompanyToAnalyzeListsV2', $prefix . 'addCompanyToAnalyzeListsV2');// 营收规模 https://api.meirixindong.com/api/v1/xd/addCompanyToAnalyzeLists
            $routeCollector->addRoute(['GET', 'POST'], '/serachCompanyByName', $prefix . 'serachCompanyByName');// 营收规模 https://api.meirixindong.com/api/v1/xd/addCompanyToAnalyzeLists
            $routeCollector->addRoute(['GET', 'POST'], '/addCompanyToAnalyzeListsByFile', $prefix . 'addCompanyToAnalyzeListsByFile');// 营收规模 https://api.meirixindong.com/api/v1/xd/addCompanyToAnalyzeLists
            $routeCollector->addRoute(['GET', 'POST'], '/startAnalysis', $prefix . 'startAnalysis');// 营收规模 https://api.meirixindong.com/api/v1/xd/addCompanyToAnalyzeLists
            $routeCollector->addRoute(['GET', 'POST'], '/delCompanyToAnalyzeLists', $prefix . 'delCompanyToAnalyzeLists');// 营收规模 https://api.meirixindong.com/api/v1/xd/addCompanyToAnalyzeLists
            $routeCollector->addRoute(['GET', 'POST'], '/getKeDongFeature', $prefix . 'getKeDongFeature');// 营收规模 https://api.meirixindong.com/api/v1/xd/addCompanyToAnalyzeLists
    ...
    private function OnlineUserRouterV1(RouteCollector $routeCollector)
    {
        ...
        $routeCollector->addGroup('/online_goods', function (RouteCollector $routeCollector) use ($prefix) {
            ...
            $routeCollector->addRoute(['GET', 'POST'], '/ZhiJinFansOrderLists', $prefix . 'ZhiJinFansOrderLists');// login
            $routeCollector->addRoute(['GET', 'POST'], '/ZhiJinFansLists', $prefix . 'ZhiJinFansLists');// login
            $routeCollector->addRoute(['GET', 'POST'], '/incomeLists', $prefix . 'incomeLists');// login

            $routeCollector->addRoute(['GET', 'POST'], '/daikuanOrderLists', $prefix . 'daikuanOrderLists');// login
        });
