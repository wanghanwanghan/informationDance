...
class AdminUserFinanceUploadRecordV2 extends ModelBase
{
    ...
    public $stateInit = 1;
    public $stateInitCname =  '文件待解析';
    public $stateParsed = 5;
    public $stateParsedCname =  '计算价格中';
    public $stateCalCulatedPrice = 10;
    public $stateCalCulatedPriceCname = '待导出';

    public $stateHasGetData = 20;
    public $stateHasGetDataCname = '已取完数据';

    public $stateCalCulatedPrice2 = 25;
    public $stateCalCulatedPrice2Cname = '已经重新计算价格';

    public $stateHasCalcluteRealPrice = 25;
    public $stateHasCalcluteRealPriceCname = '已经计算完真实价格';

    public $stateHasCalclutePriceType = 30;
    public $stateHasCalclutePriceTypeCname = '已经计算完价格类型';
    public $statusMaps ;

    public  function getStatusMaps(){
        $this->statusMaps =  [
            $this->stateInit => $this->stateInitCname,
            $this->stateParsed => $this->stateParsedCname,
            $this->stateCalCulatedPrice => $this->stateCalCulatedPriceCname,
            $this->stateHasGetData => $this->stateHasGetDataCname,
            $this->stateCalCulatedPrice2 => $this->stateCalCulatedPrice2Cname,
        ];
        return $this;
    }

    public  function addUploadRecord($requestData){
        $dbData = [
