...
class XinDongKeDongFrontEndAnalyzeHistory extends ModelBase
{
    protected $tableName = 'xin_dong_ke_dong_front_end_analyze_history';
    ...
    static  function  addRecordV2($info){
        ...
        return XinDongKeDongFrontEndAnalyzeHistory::addRecord(
            $info
        );
    }
    ...
    public static function addRecord($requestData){
        try {
           $res =  XinDongKeDongFrontEndAnalyzeHistory::create()->data([
    ...
    public static function findAllByCondition($whereArr){
        $res =  XinDongKeDongFrontEndAnalyzeHistory::create()
            ->where($whereArr)
            ->all();
        return $res;
    }
    ...
    public static function setTouchTime($id,$touchTime){
        $info = XinDongKeDongFrontEndAnalyzeHistory::findById($id);
    ...
    public static function findByConditionWithCountInfo($whereArr,$page){
        $model = XinDongKeDongFrontEndAnalyzeHistory::create()
                ->where($whereArr)
                ->page($page)
                ->order('id', 'DESC')
                ->withTotalCount();
    ...
    public static function findBySql($where){
        $Sql = " select *  
                            from  
                        `xin_dong_ke_dong_front_end_analyze_history` 
                            $where
      " ;
