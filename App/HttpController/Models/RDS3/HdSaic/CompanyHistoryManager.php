...
class CompanyHistoryManager extends ModelBase
{
    protected $tableName = 'company_history_manager';
    ...
    public static function findById($id){
        $res =  CompanyHistoryManager::create()
            ->where('id',$id)
            ->get();
        return $res;
    }
    ...
    public static function findByConditionV2($whereArr,$page){
        $model = CompanyHistoryManager::create();
