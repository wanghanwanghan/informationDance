...
<div style="width: 100%;font-size: {$this->pdf_LittleTitle}px">
    ...
    <div>
        <p style="margin-left: 20px">一、报告由北京每日信动科技有限公司出具，且郑重声明本公司与受评主体不存在任何影响评价行为独立、客观、公正的关联关系。</p>
        <p style="margin-left: 20px">二、本报告根据与该企业有关的国家企业信用信息公示系统、信用中国、裁判文书网、新闻媒体、行业数据等公开互联网网站等相关数据信息生成。以及在报告所涉主体授权同意的基础上，根据企业发票、涉税、年报等相关数据综合生成。</p>
        <p style="margin-left: 20px">三、本报告版权归北京每日信动科技有限公司所有，未经我公司书面授权，任何企业、机构或个人不得发表、修改、转发、传播本报告部分或全部内容，不得利用该报告数据进行二次加工或其他经营活动。</p>
        <p style="margin-left: 20px">四、本公司秉承独立、客观、公正的原则，为报告所涉及主体提供专业评估报告，本公司力争但不保证其真实性、准确性和时效性。在任何情况下，本公司不对因使用本报告而产生的任何后果承担法律责任，不承担由于其非控因素和疏忽而引起的相关损失和损害。</p>
        <p style="margin-left: 20px">五、北京每日信动科技有限公司保留对其信用状态的跟踪观察并根据实际情况及时调整与公布评估报告内容之权力。</p>
    </div>
